...
export class RenderTomato {
    ...
    static addTask(id, name, countNumber, importance) {
        const li = el('li', { className: `pomodoro-tasks__list-task ${importance}` },
            ...
            el('div', { className: 'burger-popup' },
                el('button', { className: 'popup-button burger-popup__edit-button' }, 'Редактировать'),
                el('button', { className: 'popup-button burger-popup__delete-button' }, 'Удалить'),
            ),
        );
